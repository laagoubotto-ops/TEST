...
export const ALL_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { to: '/crm',                  icon: 'Users',           label: 'CRM · Comptes',           shortcut: 'V' },
      { to: '/crm/pipeline',         icon: 'TrendingUp',      label: 'CRM · Pipeline' },
      { to: '/crm/tasks',            icon: 'ListChecks',      label: 'CRM · Tâches' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/automations',          icon: 'Zap',             label: 'Engine A1-A12' },
